...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT(\
    ...
    KC_ESC,   KC_A,    KC_R,    KC_S,    KC_T,    KC_D,             KC_RIGHT, LOWER,             KC_LEFT, RAISE,          KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, \
    KC_LCTL,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_LALT, KC_SPACE, KC_BSPC,        KC_LSFT,  KC_ENT,  KC_DEL,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH, TO(_DVORAK) \
  ),
