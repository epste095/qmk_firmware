...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT(\
    ...
    KC_ESC,   KC_A,    KC_R,    KC_S,    KC_T,    KC_D,             KC_LEFT, KC_DOWN,             KC_RIGHT, RAISE,          KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, \
    KC_LCTL,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_LALT, KC_SPACE, KC_BSPC,        KC_LSFT,  KC_ENT, LOWER,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH, TO(_DVORAK) \
  ),
  ...
  [_DVORAK] = LAYOUT(\
    ...
    KC_LCTL,  KC_X, KC_Q,    KC_J,   KC_K,     KC_X,      KC_V, KC_C, KC_N,        KC_U,  KC_J, KC_P,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_LGUI \
  ),
  ...
  [_RAISE] = LAYOUT( \
    ...
    RESET, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, _______,          _______, _______, _______, KC_F12,  KC_PGUP, KC_COMM, KC_DOT,  KC_PGDN, _______ \
  ),
