...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GAMING] = LAYOUT_georgi(
        TO(GAMING_2), KC_Q,    KC_Q,    KC_EQL,    KC_E,    KC_T,                       KC_TRNS,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ESC,
        KC_TRNS, KC_SCLN,    KC_A,    KC_S,    KC_D,    KC_G,                       KC_B,    KC_K,    KC_SPC,    KC_DOWN,    KC_W, KC_L,
                                   KC_LALT, KC_C, KC_N,       KC_M,  KC_J, KC_MS_BTN1
    ),

    [GAMING_2] = LAYOUT_georgi(
        KC_H, KC_4,    KC_1,    KC_W,    KC_2,    KC_3,          KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        KC_G, KC_5,    KC_A,    KC_S,    KC_D,    KC_6,          KC_N,    KC_U,    KC_I,   KC_O,   KC_P, KC_V,
                                   KC_8, KC_LALT,  KC_LSFT,        KC_TRNS,  KC_J, TG(GAMING_3)
    ),
        
    [GAMING_3] = LAYOUT_georgi(
        KC_Q, KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,          KC_U,    KC_I,    KC_O,    KC_P,    KC_Z,    KC_X,
        KC_A, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,          KC_J,    KC_K,    KC_L,   KC_C,   KC_V, KC_B,
                                   KC_BSPC, KC_N,  TO(GAMING_4),        KC_SPC,  KC_M, TO(GAMING_2)
    ),
     
    [GAMING_4] = LAYOUT_georgi(
        KC_1, KC_2, KC_3,    KC_4,    KC_5,    KC_6,             KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,    KC_ESC,
        KC_VOLD, KC_MUTE, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT,    KC_C,    KC_V,    KC_SLSH,   KC_TRNS,   KC_TRNS, KC_TRNS,
                                   KC_CAPS, KC_TAB,  KC_LALT,        KC_LCTL,  KC_ENT, TO(GAMING_3)
    )
};
